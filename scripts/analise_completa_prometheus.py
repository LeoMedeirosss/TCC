...
def analyze_prometheus_components(csv_path, repo_path):
...
if __name__ == "__main__":
    ...
    csv_path = base_dir / "analises" / "prometheus" / "components_smells_prometheus.csv"
    repo_path = base_dir / "prometheus"
    output_file = base_dir / "analises" / "prometheus" / "analise_prometheus_smells.txt"
    
    # Criar diretório de saída se não existir
    output_file.parent.mkdir(parents=True, exist_ok=True)
    
    # Executar análise
    components = analyze_prometheus_components(csv_path, repo_path)
